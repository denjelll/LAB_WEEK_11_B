...
import android.widget.Button // Diperlukan untuk findViewById<Button>
import androidx.activity.enableEdgeToEdge
import androidx.activity.result.ActivityResultLauncher // Diperlukan untuk tipe launcher
import androidx.activity.result.contract.ActivityResultContracts // Diperlukan untuk TakePicture() dan CaptureVideo()
import androidx.appcompat.app.AppCompatActivity
import androidx.core.app.ActivityCompat // Diperlukan untuk ActivityCompat.requestPermissions
import androidx.core.content.ContextCompat // Diperlukan untuk ContextCompat.checkSelfPermission
import androidx.core.view.ViewCompat
import androidx.core.view.WindowInsetsCompat
import java.io.File
import java.util.concurrent.Executors // Diperlukan untuk Executors.newSingleThreadExecutor()

// Asumsi FileHelper, FileInfo, ProviderFileManager, MediaContentHelper ada di package yang sama
...
// Otherwise, request the permission
    ...
    private fun openImageCapture() {
        ...
        // Hanya jalankan launch jika photoInfo tidak null
    ...
    private fun openVideoCapture() {
        ...
        // Menggunakan 'let' untuk memastikan videoInfo?.uri non-null sebelum diluncurkan
        videoInfo?.uri?.let { videoUri ->
